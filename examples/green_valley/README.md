...
The following network figures come from the current Green Valley case study: the
15.836 km² watershed, 39 modeled reaches, and paired unimpaired/pumped simulation
from 2010-10-01 through 2024-09-30. These reach results use the current
...
[`docs/REACH_OUTPUTS.md`](../../docs/REACH_OUTPUTS.md). The example figures and
files in this directory are the repository's public case-study outputs.
